...
validate_extracted(){
  ...
  for pf in "$s"/var/dpi/wan-registry/*.profile; do
    ...
    case "$profile" in tt|sol|kablonet|"auto_$sid") :;; *) echo 'Yedekte geçersiz DPI profil eşlemesi var.' >&2; return 1;; esac
  done
