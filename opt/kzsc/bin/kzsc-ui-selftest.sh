...
grep -q '^auto_filter_opts(){' /opt/kzsc/bin/kzsc-native-dpi.sh && grep -Fq -- '--hostlist-auto=' /opt/kzsc/bin/kzsc-native-dpi.sh && ! grep -q '^auto_filter_global_opts(){' /opt/kzsc/bin/kzsc-native-dpi.sh && ok "Otomatik hostlist seçenekleri filtre profillerinde" || bad "Otomatik hostlist seçenekleri filtre profillerinde"
