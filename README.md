...
Current release: `v0.11.2.55-generic`

Installation failed on v0.11.2.54? See [safe retry and recovery](docs/INSTALLATION.md#installation-recovery-011255--preparer-128). Do not reset the router or format Entware to resolve this audit error.
...
2. Download and fully extract `KZSC-Hazirlayici-v1.2.8.zip` from Assets.
