...
Current release: `v0.11.2.46-generic`
...
```sh
cd /opt/tmp
sha256sum -c keenetic-zapret-smart-control-v0.11.2.46-generic.tar.gz.sha256
tar -xzf keenetic-zapret-smart-control-v0.11.2.46-generic.tar.gz
cd keenetic-zapret-smart-control-v0.11.2.46-generic
sh install.sh
```
