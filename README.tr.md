...
2. Assets bölümünden `KZSC-Hazirlayici-v1.0.3.zip` dosyasını indirin ve tamamen çıkartın.
...
```sh
cd /opt/tmp
sha256sum -c keenetic-zapret-smart-control-v1.0.3-generic.tar.gz.sha256
tar -xzf keenetic-zapret-smart-control-v1.0.3-generic.tar.gz
cd keenetic-zapret-smart-control-v1.0.3-generic
sh install.sh
```
